...
productController.checkStock = async (item) => {
  ...
  if (!product) {
    console.log("존재하지 않는 상품이 포함되어 있습니다.");
    return {
      isVerify: false,
  ...
  try {
    ...
    productController.createProduct = async (req, res) => {
      try {
        ...
        return res
          .status(200)
          .json({ status: "상품 생성 성공", product: product });
      } catch (error) {
        res
          .status(400)
          .json({ status: "상품 생성 실패", error: error.message });
      }
    };
    ...
    productController.getProducts = async (req, res) => {
      try {
        ...
        res
          .status(400)
          .json({ status: "상품 조회 실패", error: error.message });
      }
    };
    ...
    productController.deleteProduct = async (req, res) => {
      try {
        ...
        res
          .status(400)
          .json({ status: "상품 삭제 실패", error: error.message });
      }
    };
    ...
    productController.updateProduct = async (req, res) => {
      try {
        ...
        res
          .status(400)
          .json({ status: "상품 수정 실패", error: error.message });
      }
    };
